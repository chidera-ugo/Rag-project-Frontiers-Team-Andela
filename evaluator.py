...
def main():
    ...
    with gr.Blocks(title="RAG Evaluation Dashboard v2", theme=theme) as app:
        gr.Markdown("# 📊 RAG Evaluation Dashboard v2")
        gr.Markdown("Optimized pipeline: `text-embedding-3-large` · dual search · query rewriting · LLM reranking")
